...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            var x = document.getElementById('customertext');
            var y = customer.id;
            if(customer.checked){       
                x.value += y + ' ';
            }
            ...
            document.getElementById('customertext').value=x.value;
            }
        </script>
        ...
        <div class="row">
            <div class="col-4" style="position:absolute;">
                <div class="list-group">
                    ...
                    <a href="admin_customerlist.php" class="list-group-item list-group-item-action bg-danger" aria-current="true">Customer List</a>
            ...
            <div class="col-8">
                <button type="button" class="btn btn-success bg-primary" onclick="window.location='admin_customerlist.php';"> Go Back</button><br><br>
                ...
                <div class="list-group">
                    ...
                    <label class="list-group-item">
                        <input class="form-check-input me-1" type="checkbox" id="<?php echo $row['cust_id'] ?>" onclick="func(this)">
                ...
                <br><br>
                <form action="customerdelete.php" method="POST" style="text-align:center;">
